<template>
	<view class="container">
		...
		<view class="user-box">
			...
			<view class="flex between user-bottom">
				...
				<navigator class="f12 item" hover-class="none" url="./follow">
					<view class="f18 bold">{{shop.count}}个</view>
		...
		<view class="cell-box">
			...
			<navigator class="cell" hover-class="none" url="./post">
				<image src="../../static/images/my11.png" class="icon"></image>
				<text class="flex1">我的发布</text>
				<uni-icons type="right" size="16"></uni-icons>
			</navigator>
			<navigator class="cell" hover-class="none" url="./customer">
		...
		<uni-popup ref="popup" type="bottom">
			<view class="post-box">
				...
				<view class="post">
					...
					<navigator class="item" hover-class="none" url="../post/zufang">
						<image src="../../static/images/f2.png" class="icon"></image>
						<view>租房</view>
					</navigator>
					<navigator class="item" hover-class="none" url="../post/news">
